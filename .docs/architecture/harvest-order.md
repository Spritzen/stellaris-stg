...
> **Then** — [STNH art is additive-only](stnh-art.md) · [Conflict register](conflict-register.md) · [decision 05](../decisions/05-harvest-order.md)
...
19  ASB Ironman
20  Diverse Rooms (Updated)              # minus its second room_selector — decision 48
...
28+ Walshicus' 22 Trek shipsets          # decision 18; gfx/, common/graphical_culture
                                         # and flags/trek ADDITIVELY — decision 49
...
──  the prune closure                    # decision 45; removes what nothing names
```
...
([decision 11](../decisions/11-drop-cinematic-camera-and-ambient-soundtracks.md)).
...
([decision 43](../decisions/43-planet-scale-system-length.md)). Keeping it is a
...
> count. [Decision 12](../decisions/12-fix-source-errors-dont-drop.md).
