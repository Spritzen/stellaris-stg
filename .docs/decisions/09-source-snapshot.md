# 09 — The build reads `.source/`, not `/workshop`

**Decided:** 2026-08-01. **Supersedes [04](04-no-source-archive.md).**
...
stg-build/            the mod tree
  ↑  symlink (make link, once) — decision 13
/paradox/stellaris/mod
```

## Why

Decision 04 accepted two risks to avoid an archive. Both turned out to be
cheaper to fix than to carry.

**1. Unsubscribing destroyed the ability to rebuild.** 04's mitigation was "the
