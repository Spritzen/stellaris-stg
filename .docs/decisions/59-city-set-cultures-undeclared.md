# 59 — Five city sets with complete art and no declaration: the designer hid the empires

**Resolved 2026-08-08**, from the Klingon live run of the same day.
**Corrected in part, 2026-08-25:** the reasoning below rests on `stg_minor_undine_vanguard` being
...
[decision 41](41-planet-scale-system-length.md) — one line, post-init,
...
room side — [decision 46](46-room-selector-merge.md)'s `room_selector` offers
...
This is [decision 32](32-src-shadows-drop-source-declarations.md)'s rule in a new
...
[decision 16](16-stnh-shipsets-on-a-vanilla-chassis.md).
...
[Decision 09](09-species-class-keys-unprefixed.md).
