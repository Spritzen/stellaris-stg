# 95 — The picker offers one galaxy, and withdrawing a scenario means occupying its path and declaring nothing
...
**Follows** [decision 94](94-static-map-lanes-are-generated.md), which is what
made the map worth defaulting to, and
[decision 93](93-static-galaxy-scenario.md), which built it.
...
- **`exclude:` on Yet Another Galaxy Enhancement Mod** for its nine scenarios and
  ...
  and [decision 12](12-fix-source-errors-dont-drop.md) governs the rest. This is
...
- **An `src_regression_ack` entry for the five.** The check that fired is
  [34](34-src-shadows-drop-source-declarations.md)'s, and it was right to: each
...
- **the map is the single point of failure.** Before this, a defect in
  ...
  Now a defect in it is the whole mod. [94](94-static-map-lanes-are-generated.md)
...
The AI Federation remains open from [93](93-static-galaxy-scenario.md); nothing
here touches it.
