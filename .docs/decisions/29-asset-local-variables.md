# 29 — `@variables` in art files are file-local, and copying an entity leaves them behind
...
([decision 28](28-clone-discards-sibling-locators.md)). Those donor files declare
...
about `clone` and locators (decision 28) — same lesson, one level down.
