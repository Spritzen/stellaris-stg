# 38 — The 2026-08-07 15:41 run's small defects, and what each one cost

**Status:** decided, 2026-08-07

The run loaded STG (`enabled_mods:["mod/star_trek_galaxies.mod"]`), threw 1,309
errors in 193 KB, and crashed nothing. [Decision 36](36-real-space-drops-sol-neighbours.md)
and [decision 37](37-sbx-citadel-slot-renumbering.md) cover the two structural
...
[decision 14](14-native-linux-runtime.md), not by ASB, and would be invisible
...
[decision 39](39-civic-granted-species-traits.md). The section is kept because
