# 30 — Declare the 34 selector-named species classes; retire the ack
...
[18](18-minor-power-species-class-keys.md) and
[19](19-species-class-localisation.md).
...
family decision 19 requires. `dangling_identifier_ack` is now `[]` — kept, empty,
so the next reader finds the note rather than wondering why there is no ack.

**Four were not new classes but misspellings of our own** — decision 18 applied
...
This is [decision 25](25-quoted-class-keyword.md)'s lesson from the other side.
