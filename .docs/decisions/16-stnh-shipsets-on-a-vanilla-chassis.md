# 16 — STNH shipsets on a vanilla chassis

**Date:** 2026-08-03
**Status:** applied, then **superseded in part by
[decision 17](17-walshicus-shipsets-replace-stnh-hulls.md)** — nine of the
...
([decision 26](26-weapon-locator-positions.md)) — but neither holds in an entity
that also says `clone`, which discards everything declared beside it
([decision 28](28-clone-discards-sibling-locators.md)). `gen_shipsets.py` emits
...
name — was rebuilt twice more; decision 28 is the current story.
...
The same warning as [decision 15](15-phase-3-clothing-triggers.md): the failure
