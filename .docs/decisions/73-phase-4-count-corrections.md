# 73 — Four numbers in Phase 4 were wrong, and the worst of them was another database's right number

**Status:** decided, 2026-08-09
**Follows:** [70](70-trek-anomalies.md), [71](71-trek-archaeology.md),
[72](72-trek-story-events.md)
**Corrects in part:** [70](70-trek-anomalies.md)'s restricted-category tally and
[72](72-trek-story-events.md)'s on_action count and story rate. Both keep their
...
|---|---|---|---|
| `src/common/anomalies/stg_anomaly_categories.txt:4` | vanilla's **137** anomaly categories | **327** | no derivation reaches 137; decision 70's own body says 327 |
...
the exact failure mode [decision 66](66-doc-inventory-checks.md) added
...
([61](61-terran-empire-mirror-uniforms.md)), and nothing in the story pool for
it.
...
[Decision 70](70-trek-anomalies.md) says "seven of the 21 are `max_once` or
...
**Not changed:** the bodies of decisions 70 and 72. A decision records what was
...
[decision 16](16-stnh-shipsets-on-a-vanilla-chassis.md) uses.
...
**`clear_deposits` is not absolute in vanilla**, though decision 70 states it as
...
Finding 5 — that decision 71's headline `weight` claim had no check behind it —
is [decision 74](74-reachability-checks.md), because it is a check rather than a
correction.
