# 64 — The Terran Empire's mirror uniforms, and four female rows with no species gate

**Status:** decided, 2026-08-08
**The in-game half of** [decision 22](22-empire-designer-clothes.md), whose
...
All three were on [decision 16](16-phase-3-clothing-triggers.md)'s INERT list at
...
correctly, because decision 22 had gated `game_setup` on 2026-08-08.

**Getting one scope right says nothing about the others.** That is decision 22's
