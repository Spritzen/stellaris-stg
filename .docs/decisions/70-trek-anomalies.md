# 70 — Phase 4 starts with anomalies, because they are the one part of "a voice" with a yardstick

**Status:** decided, 2026-08-09, and **corrected in part by
[decision 73](73-phase-4-count-corrections.md)** — the restricted-category tally
...
exactly as written.
**Follows:** [69](69-event-picture-families.md)
**Gains the check it asked for:** [74](74-reachability-checks.md) — `spawn_chance`
...
[decision 56](56-ship-name-pools.md) and [67](67-ship-class-names.md) could.
...
1. **Anomalies have a yardstick and archaeology does not.** Vanilla's base game
   ...
   [decision 68](68-class-name-thematic-fill.md) made with class-name pool
   sizes.
...
[decision 69](69-event-picture-families.md) is the enabling work, and it had to
...
padded, which is the call [decision 68](68-class-name-thematic-fill.md) made
...
on screen. That is [decision 45](45-minor-power-names-truncated.md)'s silence in
a fifth database.
...
and the same two-scope shape as [decision 49](49-prescripted-loc-scope.md).
