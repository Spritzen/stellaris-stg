# 54 — A prescripted ruler pins no clothes index at all

**Status:** decided, 2026-08-08
**Supersedes the second half of** [decision 21](21-prescripted-ruler-appearance.md),
...
Federation official has no Starfleet entry to reach at all — decision 15 chose
...
[decision 20](20-empire-designer-clothes.md) put
...
Decision 20 found it in the designer, decision 21 in the pinned index's value,
...
decision 21 recorded: `clothes` indexes whatever the selector produces at
evaluation time and nothing on disk says what that list is.

The designer keeps decision 20's dedicated Federation President art. That the
...
pins it any more** — which is what decision 21 claimed while still writing an
