# 58 — The music player draws the declaration name, and 16 had no key

**Status:** decided, 2026-08-08
**Follows** [decision 52](52-federation-anthem.md), which got the Federation
...
resolves to itself still resolves*. That is decision 45's silence in a different
...
1. **STNH's own `localisation/`**, which STG does not vendor (plan.md §3 takes
   ...
   same way the Trek star names were.
...
[decision 09](09-species-class-keys-unprefixed.md). Only `stg_ufp_anthem` is
