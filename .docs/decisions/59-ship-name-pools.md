# 59 — STNH's ship registries, folded onto vanilla's ship sizes
...
STG flies a vanilla chassis ([decision 18](18-walshicus-shipsets-replace-stnh-hulls.md)),
...
Decision 47's rule is enforced on the way in: a harvested value that is still a
