# 37 — `attach` edges into pruned STNH art — kept, not integrated
...
Decision 24's lesson was that *an include list scoped by directory does not
...
[decision 18](18-walshicus-shipsets-replace-stnh-hulls.md) pruned — Walshicus
...
**Not exclude either**, per [decision 12](12-fix-source-errors-dont-drop.md).
