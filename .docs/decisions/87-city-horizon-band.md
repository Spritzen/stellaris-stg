# 87 — Vulcan's skyline filled 325 of 400 rows against a family median of 289, and the fix is a resample, not a crop

**Status:** decided, 2026-08-24
**Falsifies** [decision 70](70-vulcan-city-framing.md), which measured this art
three ways and left it alone.
**Supersedes** [decision 66](66-city-set-canvas-overflow.md)'s treatment of the
...
[Decision 70](70-vulcan-city-framing.md) reviewed the same complaint on
2026-08-08, measured the pipeline, the GUI frame and the source file, found no
...
symptom, and it sits on the axis decision 70 ruled out.
...
|---|---|---|
| pad to 560×367, scale (`fit: canvas` as written) | 247 | too short — the "flat and low" look [decision 66](66-city-set-canvas-overflow.md) removed |
...
bands that letterboxing would leave are the seam
[decision 70](70-vulcan-city-framing.md) refused, and refusing it was right.
...
([decision 08](08-stnh-art-shadows-vanilla.md)). Every Trek set sits beside
