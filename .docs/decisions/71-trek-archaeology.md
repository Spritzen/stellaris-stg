# 71 — Trek archaeology, and the one field in the format that decides whether any of it is ever seen

**Status:** decided, 2026-08-09
**Follows:** [70](70-trek-anomalies.md)
**Gains the check it asked for:** [74](74-reachability-checks.md) — the `weight`
...
[decision 68](68-class-name-thematic-fill.md)'s call about pool sizes applied to
a third database.
...
That is the same class of defect as [decision 59](59-city-set-cultures-undeclared.md)'s
...
until something declared it — [decision 69](69-event-picture-families.md) is what
...
[70](70-trek-anomalies.md)'s split applied here — so its modifier is timed, and
