# 25 — a quoted `class` keyword is a different keyword

*Decided 2026-08-03. The fourth round on the file
[decision 23](23-real-home-systems.md) introduced and
[decision 24](24-home-system-classes.md) has fixed three times.*
...
Decision 24's round three had predicted the ownership half and fixed it —
...
instance of the same mistake, in decision 24's own calibration notes.
