# 07 — The deploy target is inside the Proton prefix; the launcher does not scan `mod/`
...
> **SUPERSEDED ON LOCATION, 2026-08-02 — [decision 15](15-native-linux-runtime.md).**
...
> became `make link` — [decision 13](13-build-dir-and-symlink-deploy.md).
>
...
vendored copy of a vanilla file ([decision 08](08-stnh-art-shadows-vanilla.md)).
