# 20 — `game_setup` is a scope, and a shared selector has to gate it too

**Status:** decided, 2026-08-03
**Completes** [decision 15](15-phase-3-clothing-triggers.md), which gave the STNH
...
another silence failure, like decisions 18 and 19.
