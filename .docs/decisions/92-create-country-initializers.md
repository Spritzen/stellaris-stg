# 92 — AI Trek empires are created by their home system's initializer, not drawn from the prescripted pool

**Status:** decided, 2026-08-26
**Follows** [decision 91](91-static-galaxy-is-the-mechanism.md), which found the
static map and stopped one step short of what the map is *for*.
**Supersedes the direction of** [decision 86](86-prescripted-empires-never-drawn.md)
and [decision 88](88-playable-gates-the-design-database.md): both are correct
about what they fixed and both were tuning a mechanism that does not place AI
empires in a total conversion.
...
error count, and [decision 12](12-fix-source-errors-dont-drop.md) requires it be
...
[91](91-static-galaxy-is-the-mechanism.md)). The 99 stay as they are and stay
...
identity half — 36 real home systems ([25](25-real-home-systems.md)), 99
...
name from STNH's maps ([52](52-trek-star-names.md)).
