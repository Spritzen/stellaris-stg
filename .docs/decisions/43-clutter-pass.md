# 43 — Unreferenced content goes by default, and the closure decides
...
| **shadowing** | it sits at a vanilla path on purpose, so vanilla's own references reach it ([decision 07](07-stnh-art-shadows-vanilla.md)) | 1,428 |
...
**[Decision 35](35-attach-edges-into-pruned-art.md), second half.** It found
...
tidiness."* That trade is now made, on purpose, and for a reason decision 35
...
Decision 35's specific four files are untouched: they live under `gfx/models`,
...
not reversed, the way [decision 17](17-walshicus-shipsets-replace-stnh-hulls.md)
...
**[Decision 11](11-fix-source-errors-dont-drop.md) does not reverse.** No source
...
[decision 22](22-group-c-texture-references.md)'s lesson was that an include
...
[22](22-group-c-texture-references.md),
[32](32-src-shadows-drop-source-declarations.md) and
[35](35-attach-edges-into-pruned-art.md) already record three times over, one
...
precisely the artefact [decision 22](22-group-c-texture-references.md) showed
...
(decision 31). So the closure was blinded to one declaration file at a time:
...
records which of the two this is ([decision 27](27-merge-semantics-per-directory.md)).
...
decision 11 excluded, and the one nobody swept for afterwards.
...
[decision 10](10-drop-cinematic-camera-and-ambient-soundtracks.md): STG is
