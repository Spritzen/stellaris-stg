# 84 — Thirty shipset descriptions were keyed to the wrong database, six home systems named a body twice, and one finding falsified itself

**Status:** decided, 2026-08-22
**Follows** [decision 83](83-widen-attach-points-and-two-new-checks.md), whose
...
**Follows** [decision 62](62-city-set-cultures-undeclared.md), whose mechanism
[analysis 2026-08-16](../analysis/2026-08-16.md) read forwards, and which turns
out not to run in that direction.
**Follows** [decision 25](25-real-home-systems.md), whose generator carried two
...
[Decision 12](12-fix-source-errors-dont-drop.md) says fix a source's errors, and
...
[decision 45](45-clutter-pass.md).
...
> [decision 83](83-widen-attach-points-and-two-new-checks.md) for the same
