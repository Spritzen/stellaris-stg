...
[Decision 76](76-trek-archaeology.md) shipped the second. This is the third and
...
[decision 76](76-trek-archaeology.md)'s `weight = 0` and
[decision 62](62-city-set-cultures-undeclared.md)'s undeclared graphical culture
...
same shape as `UBUME_BABY_CAT` is for [75](75-trek-anomalies.md) and
`cstorms.1300` is for [76](76-trek-archaeology.md).
...
> the tree, so [75](75-trek-anomalies.md)'s floor of 1 stands as recorded.
