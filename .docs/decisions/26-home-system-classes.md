# 26 — STNH identifiers in generated home systems
...
[decision 25](25-real-home-systems.md), which introduced
...
was STG and not a vanilla run (the check decision 15 exists for).
...
earlier by decision 25's new tool — named **nine classes that nothing in the
...
The rule is decision 25's own: *habitability is what matters*. Every one of the
