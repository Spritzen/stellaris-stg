# 26 — Weapon locators: `.asset` declarations do count, and they need positions

**Date:** 2026-08-03
**Status:** accepted, with one qualifier added by
[decision 28](28-clone-discards-sibling-locators.md)
**Supersedes:** the claim in `tools/gen_shipsets.py`'s `Emitter` docstring that
`.asset` locator declarations "do nothing".

> **Read decision 28 with this.** A declaration satisfies the engine only in an
...
decision 16/18 territory, not this one.
