# 22 — Group C is a texture problem, and the include list could not see it
...
[decision 17](17-walshicus-shipsets-replace-stnh-hulls.md)'s prune.*
...
17 pruned. Each of the 132 had exactly one home in `.source/`, so no path is
ambiguous.
...
4.4 regression of decision 07's kind — System Scale invented references to art
