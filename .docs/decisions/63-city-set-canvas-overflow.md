# 63 — A file taller than the canvas was scaled by two different factors

**Status:** decided, 2026-08-08
**The third and last door into** [decision 55](55-city-set-geometry.md)'s
symptom. 58 fixed the files smaller than STNH's canvas,
[60](60-city-set-family-targets.md) fixed the ones shadowing no vanilla path,
...
sentence* decisions 55 and 60 were reported with: buildings low and small,
