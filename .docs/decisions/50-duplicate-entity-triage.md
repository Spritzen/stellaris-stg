# 50 — the 13 duplicate entity declarations, triaged

**Resolved 2026-08-08.** Closes the first of plan.md §8's three standing-warning
items. Continues [decision 31](31-duplicate-entity-declarations.md), which built
...
Decision 31 established that a mod redeclaring a **vanilla** entity from a
...
[decision 36](36-real-space-drops-sol-neighbours.md) reasoned about from the other
...
`vendor.yml` patch — renamed rather than deleted, per decision 31's Saturn
...
([decision 17](17-walshicus-shipsets-replace-stnh-hulls.md)). Renamed, not
...
name — the indirection [decision 33](33-station-section-attach-points.md) warns
