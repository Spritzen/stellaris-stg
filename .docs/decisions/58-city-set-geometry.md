# 58 — STNH's city layers are a 560×280 canvas in an 800×400 planet view

**Status:** decided, 2026-08-08
**The same defect as** [decision 42](42-event-picture-geometry.md), one
...
Re-cut them with `resample_to_vanilla:`, which already existed for decision 42,
...
by [decision 49](49-flags-city-sets.md) should still show cities at 70%. Fixing
them means asserting 800×400 rather than reading it, which is the one thing
decision 42 refused to do — so it waits for a live run to confirm the symptom
