# 74 — `gfx/event_pictures` is two families, and reading it as one left 865 pictures unasked

**Status:** decided, 2026-08-09
**Follows:** [42](42-event-picture-geometry.md), [58](58-city-set-geometry.md), [63](63-city-set-family-targets.md)
...
`interface/` ([decision 42](42-event-picture-geometry.md) predicted exactly
...
texture into a window cut for 450×150**, which is decision 42's defect, in
decision 42's own directory, waiting behind the first sprite anybody writes.
...
`target: family` is the lever [decision 63](63-city-set-family-targets.md) built
...
strip rule decision 42 already had.
...
decision 42's were: twelve strips rendered to PNG and looked at. All twelve are
legible stills of the scene the filename names.

## What this does not settle

**Whether STNH's pictures are framed for a 3∶1 crop.** Decision 42 verified that
