# Decision 11 — drop Cinematic Camera, Kammarheit and Apocryphos
...
[decision 12](12-fix-source-errors-dont-drop.md), which generalised what this
...
> harvest. [Decision 43](43-planet-scale-system-length.md) has the refutation
> table.
>
...
[decision 12](12-fix-source-errors-dont-drop.md) then made into the rule, and
