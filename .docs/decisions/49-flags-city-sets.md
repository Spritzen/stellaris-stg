# 49 — The shipsets' 39 extra flags, the 22 empires on a grey placeholder, and the Trek city sets

**Resolved 2026-08-08.** Closes the *flags* and *city sets* items in plan.md §6
Phase 3's "Outstanding" list. Extends
[decision 18](18-walshicus-shipsets-replace-stnh-hulls.md), which kept STNH as
...
Klingon, Romulan and Cardassian heraldry five major powers fly. Decision 18
...
decision 18's whole point. So `additive_only` now also takes a **list of path
prefixes**:
