# 37 — SBX renumbers vanilla's citadel gun slots and vanilla's own design breaks
...
[decision 36](36-real-space-drops-sol-neighbours.md), found in the same run.
...
middle of the ship ([decision 26](26-weapon-locator-positions.md)). It cannot
