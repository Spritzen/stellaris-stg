# 78 — A stale ratio was guarding the hull family, the female selector was never swept, and no generator was ever a checked fixpoint

**Status:** decided, 2026-08-22
**Follows** [decision 77](77-hull-section-attach-points.md), whose repair this
finally puts a check behind.
**Follows** [decision 33](33-station-section-attach-points.md), whose scope
constant this widens — and whose reason for the scope had expired.
**Follows** [decision 66](66-doc-inventory-checks.md): all three items below came
out of reading the docs against the tree, not out of a live run.
**Its 196 is corrected by** [decision 80](80-selector-textures-that-resolve.md),
...
[decision 33](33-station-section-attach-points.md), and its docstring recorded
...
vanilla-only and 5 in vendored files. Decision 77's 230 attach points collapsed
...
- **The other four fly their own culture's art**, and **28 of vanilla's 33
  ...
  caveat decision 77 records for vanilla's titan and colossus frames, which name
...
dropped from the wanted set for the same reason decision 77 dropped it: every
...
undocumented `make` target — which is [decision 66](66-doc-inventory-checks.md)'s
