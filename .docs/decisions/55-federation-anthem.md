# 55 — the Federation anthem plays, and a check that a track is reachable
...
it is the failure [decision 27](27-quoted-class-keyword.md) records. It plays for
...
lesson of [decision 24](24-group-c-texture-references.md) applies to `music/` as
...
Calibrated in both directions per [decision 30](30-clone-discards-sibling-locators.md):
