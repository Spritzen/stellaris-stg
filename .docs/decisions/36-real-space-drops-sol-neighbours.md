# 36 — Real Space drops ten Sol-neighbour initializers Planetary Diversity still calls
...
directory already produces. Decision 29 is the neighbouring hazard.
...
and `check_src_source_regression` ([decision 32](32-src-shadows-drop-source-declarations.md))
