# 33 — One entity name declared twice silently decides which art renders
...
every live run before it, as [decision 17](17-stnh-shipsets-on-a-vanilla-chassis.md)
already noted.
...
([decision 18](18-walshicus-shipsets-replace-stnh-hulls.md)); STNH's leftover copy
