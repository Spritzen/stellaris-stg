# 85 — The 196 was 117, two thirds of it was never a content call, and the thirteen that were took one policy rather than thirteen decisions

**Status:** decided, 2026-08-24
**Follows** [decision 83](83-widen-attach-points-and-two-new-checks.md), which
...
decision 83's eleven patches only *add* to this population, by moving ten rows
...
species wear — the same reason decision 83 accepted a duplicated entry rather
...
- `tos_mirror_human_female_ruler.dds`, **8 rows**, the largest single item.
  ...
  [decision 22](22-empire-designer-clothes.md) took the male file's gating.
...
The question decision 83 split now has both halves in
...
cheaper half of that trade — decision 83's reasoning, applied thirteen times.
