# 62 — The rotation is 27 tracks, not 86, and six of them were one recording

**Status:** decided, 2026-08-08
**Reverses the "kept at the user's direction" half of**
[decision 58](58-music-player-track-names.md), at the same user's direction.
...
since Stellaris picks uniformly across `song` entries. Decision 58 found the six
...
decision 13 pattern. `maintheme` is the one kept — vanilla's own name, and the
main menu's.
...
rotation, and those are the two halves decision 52 exists to keep apart. The
...
(decision 52 found the second, 61 the third), and *which of the declared tracks
