# 18 — Eight minor powers take STNH's species-class key, not a near miss

**Status:** decided, 2026-08-03
**Supersedes nothing.** Extends [decision 09](09-species-class-keys-unprefixed.md)
...
STG had been shipping all eight since the minor-power harvest; nobody
reconciled the two lists. Three of the entries were even annotated `# Benzite`, `# Denobulan`,
`# Tellarite`.
...
Decision 09's reasoning applies unchanged: **the art names the key, so the art
