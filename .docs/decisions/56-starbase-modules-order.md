# 56 — `common/starbase_modules` fed by two sources: looked at, acked
...
one file ([decision 29](29-merge-semantics-per-directory.md)'s borrowed list;
...
[decision 39](39-sbx-citadel-slot-renumbering.md) already records it doing to
