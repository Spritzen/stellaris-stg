# Decision 09 — the five species classes take STNH's bare keys, not `STG_`
...
decision 07 rejected vendoring its triggers: it declares `archetype = HUMANOID`
...
The same argument, applied to the same body of vendored art. Decision 07 made it
