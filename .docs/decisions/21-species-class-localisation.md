# 21 — Species class loc keys hang off the class key, unprefixed

**Status:** decided, 2026-08-03
**Extends** [decision 10](10-species-class-keys-unprefixed.md) and
[decision 20](20-minor-power-species-class-keys.md) from the class key to the
...
it. `error.log` said nothing: this is a silence-failure class, like decision 20's.
...
user named are the Phase 2 frontier powers; the other 79 are decision 19's
AI-only minor powers, which have the same defect and which no empire designer
