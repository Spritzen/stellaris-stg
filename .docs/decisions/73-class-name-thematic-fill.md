# 73 — A class-name pool is one semantic field, and vanilla is the model for filling one

**Status:** decided, 2026-08-09
**Follows** [decision 72](72-ship-class-names.md), which harvested everything STNH
declares and left the rest measured.

## What was left

Decision 72 took every class name STNH has and stopped there, on the grounds
...
and decision 72's demotion rule took them out of generic on its own. Where a
...
- **The 46 AI-only minor lists stay generic-only.** Filling them means ~1,000
  ...
  Decision 72's finding stands for them: thin is not broken.
...
- **Malon's inherited pools name a TYPE, not a class.** STNH declares
  ...
  makes ([decision 12](12-fix-source-errors-dont-drop.md)); the titan fill sits
  alongside them. **Flagged for the next live run.**

## What this does not settle

The same thing decision 72 could not: **whether any of it reads right, which
