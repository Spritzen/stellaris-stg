...
vanilla warships. See .docs/decisions/16-stnh-shipsets-on-a-vanilla-chassis.md,
and 17-walshicus-shipsets-replace-stnh-hulls.md for why this now covers five
...
2026-08-03. See .docs/decisions/26-weapon-locator-positions.md.
...
# them -- see .docs/decisions/17-walshicus-shipsets-replace-stnh-hulls.md. The
...
def _locator_spans(body: str) -> list:
    ...
    ever logged. See .docs/decisions/26-weapon-locator-positions.md.
    """
    out, depth, i = [], 0, 0
    while i < len(body):
        c = body[i]
...
# .docs/decisions/17-walshicus-shipsets-replace-stnh-hulls.md.
#
...
# See .docs/decisions/28-clone-discards-sibling-locators.md.
#
...
#
# See .docs/decisions/16-stnh-shipsets-on-a-vanilla-chassis.md.
...
# that provides it -- .docs/decisions/17-walshicus-shipsets-replace-stnh-hulls.md.
#
# GENERATED by tools/gen_shipsets.py -- edit the generator, not this file.
#
# KEYS ARE DELIBERATELY UNPREFIXED, for the same reason the species classes are
# (.docs/decisions/09-species-class-keys-unprefixed.md): the engine resolves
...
# .docs/decisions/16-stnh-shipsets-on-a-vanilla-chassis.md.
"""
...
def main():
    ...
    print(f"  wrote {OUT} ({n} entities, {em.unmounted} gun mount(s) placed from "
          ...
          f"copied out rather than cloned — decisions 26 and 28)")
